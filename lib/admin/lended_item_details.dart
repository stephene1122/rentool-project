...
class ActiveLendedItemsDetails extends StatefulWidget {
  ActiveLendedItemsDetails(
      {Key? key, required this.rentItemId, required this.lendId})
      : super(key: key);
  ...
  @override
  State<ActiveLendedItemsDetails> createState() =>
      _ActiveLendedItemsDetailsState();
}

class _ActiveLendedItemsDetailsState extends State<ActiveLendedItemsDetails> {
  double rating = 0;
